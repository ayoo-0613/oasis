"""CLI and wrapper for deterministic competitor archetypes.

Example:
    python -m generator.business_simulation.roles.competitor.generate_archetypes --pretty
"""
...
def generate_competitor_archetypes(
    schema_config: dict[str, Any],
    archetype_config: dict[str, Any],
) -> list[dict[str, Any]]:
    """Generate deterministic competitor archetype agents."""
...
def main() -> None:
    """CLI entrypoint."""
    run_archetype_generator_cli(
        description="Generate deterministic competitor archetype agents.",
...
__all__ = [
    ...
    "generate_competitor_archetypes",
    "load_archetype_config",
    "load_schema_config",
    "main",
]
