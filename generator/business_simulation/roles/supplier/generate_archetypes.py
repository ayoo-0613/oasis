"""CLI and wrapper for deterministic supplier archetypes.

Example:
    python -m generator.business_simulation.roles.supplier.generate_archetypes --pretty
"""
...
def generate_supplier_archetypes(
    schema_config: dict[str, Any],
    archetype_config: dict[str, Any],
) -> list[dict[str, Any]]:
    """Generate deterministic supplier archetype agents."""
...
def main() -> None:
    """CLI entrypoint."""
    run_archetype_generator_cli(
        description="Generate deterministic supplier archetype agents.",
