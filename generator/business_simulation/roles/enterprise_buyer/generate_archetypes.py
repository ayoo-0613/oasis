"""CLI and wrapper for deterministic enterprise buyer archetypes.

Example:
    python -m generator.business_simulation.roles.enterprise_buyer.generate_archetypes --pretty
"""
...
def generate_enterprise_buyer_archetypes(
    schema_config: dict[str, Any],
    archetype_config: dict[str, Any],
) -> list[dict[str, Any]]:
    """Generate deterministic enterprise buyer archetype agents."""
...
def main() -> None:
    """CLI entrypoint."""
    run_archetype_generator_cli(
        description="Generate deterministic enterprise buyer archetype agents.",
...
__all__ = [
    ...
    "generate_enterprise_buyer_archetypes",
    "load_archetype_config",
    "load_schema_config",
    "main",
]
