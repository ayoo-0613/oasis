"""CLI and wrapper for deterministic regulator archetypes.

Example:
    python -m generator.business_simulation.roles.regulator.generate_archetypes --pretty
"""
...
def generate_regulator_archetypes(
    schema_config: dict[str, Any],
    archetype_config: dict[str, Any],
) -> list[dict[str, Any]]:
    """Generate deterministic regulator archetype agents."""
...
def main() -> None:
    """CLI entrypoint."""
    run_archetype_generator_cli(
        description="Generate deterministic regulator archetype agents.",
